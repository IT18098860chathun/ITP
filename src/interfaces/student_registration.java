...
public class student_registration extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setBackground(new java.awt.Color(244, 180, 26));
        jLabel2.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/update.png"))); // NOI18N
        jLabel2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(20, 61, 89), 5));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/registration form (2).png"))); // NOI18N
    ...
    private void jLabel4MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel4MouseClicked
        registration_form1 r1 = new registration_form1();
        r1.setVisible(true);
        this.dispose();
    ...
    private void jLabel3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel3MouseClicked
        delete_form d1 = new delete_form();
        d1.setVisible(true);
        this.dispose();
