...
public class delete_form extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Buddhist & pali University of Sri Lanka");
        ...
        jTable1.setBackground(new java.awt.Color(244, 212, 122));
        ...
        jButton1.setForeground(new java.awt.Color(244, 180, 26));
        ...
        jButton3.setForeground(new java.awt.Color(244, 180, 26));
        ...
        jButton4.setForeground(new java.awt.Color(244, 180, 26));
        ...
        jButton6.setForeground(new java.awt.Color(244, 180, 26));
        ...
        jPanel6.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(244, 212, 122), 3));

        jLabel5.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
        jLabel5.setText("Student ID");

        jLabel6.setFont(new java.awt.Font("Arial Rounded MT Bold", 0, 18)); // NOI18N
        jLabel6.setText("Name of the applicant :");
        ...
        jLabel9.setBackground(new java.awt.Color(244, 212, 122));
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGap(20, 20, 20)
                .addComponent(jScrollPane1, javax.swing.GroupLayout.PREFERRED_SIZE, 1898, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(20, 20, 20))
        );
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String sql = "Select *  LIKE '%"+ Nameoftheapplicant +"%' or `Id` = '%"+ Id +"%'";
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        ...
        if (x==0)
        {
            //String a = jTable1.setValueAt(,).toString();
        }
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        try {
            ...
            jLabel8.setText(Id);
            jLabel9.setText(Nameoftheapplicant);
